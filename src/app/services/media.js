...
function mediaFactory(MEDIA, MEDIA_PRIORITY, $rootScope, $window) {
    var queries = {};
    var mqls = {};
    var results = {};
    var normalizeCache = {};

    $media.getResponsiveAttribute = getResponsiveAttribute;
    $media.getQuery = getQuery;
    $media.watchResponsiveAttributes = watchResponsiveAttributes;
